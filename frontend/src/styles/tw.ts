...
export const RETRO_TICKET_PASS =
  'relative flex items-center justify-between rounded-xl py-[26px] px-8 min-h-[108px] gap-6 flex-wrap box-border cursor-pointer select-none [transition:box-shadow_0.22s_cubic-bezier(.16,1,.3,1),border-color_0.22s_ease,background_0.22s_ease] [[data-theme=win95]_&]:bg-[#c0c0c0] [[data-theme=win95]_&]:border-2 [[data-theme=win95]_&]:border-white [[data-theme=win95]_&]:shadow-[inset_2px_2px_0_#fff,inset_-2px_-2px_0_#000,3px_3px_0_#000] [[data-theme=win95]_&]:rounded-none [[data-theme=win95]_&]:text-black [[data-theme=terminal]_&]:bg-none [[data-theme=terminal]_&]:bg-[rgba(10,31,10,.96)] [[data-theme=terminal]_&]:border-2 [[data-theme=terminal]_&]:border-[#33ff33] [[data-theme=terminal]_&]:shadow-[0_0_16px_rgba(51,255,51,.25)] [[data-theme=terminal]_&]:rounded-[4px] [[data-theme=terminal]_&]:text-[#33ff33]';
