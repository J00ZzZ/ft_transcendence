...
L'App est un jeu de Ludo multijoueur en ligne basé sur un navigateur. Il offre :

- L'inscription et la connexion au compte (e-mail/mot de passe, et éventuellement via Google, GitHub, ou 42)
- Des modes de jeu : Joueur contre Joueur (PvP), Joueur contre Bot (PvE), et hotseat local
- L'historique des parties, les statistiques, les classements et les succès
- Des amis, des invitations et des notifications en temps réel
...
- Vous êtes responsable de l'exactitude des informations que vous fournissez lors de l'inscription.
- Vous devez garder votre mot de passe confidentiel. Vous êtes responsable de toutes les activités qui se produisent sous votre compte.
...
Vous acceptez **ne pas** :

- Utiliser l'App à des fins illégales ou en violation des lois applicables (y compris la Loi malaisienne sur la protection des données personnelles 2010 et la Loi sur les crimes informatiques 1997).
- Tenter d'accéder illégalement à l'App, ses serveurs, sa base de données, ou les comptes d'autres utilisateurs.
- Utiliser des outils automatisés, des robots, des scripts, ou d'autres moyens pour manipuler déloygalement des parties, des notes ou des classements.
- Exploiter, reverse-engineer, ou interférer avec la sécurité ou l'infrastructure de l'App, ou agir de toute autre manière constituant une infraction informatique au sens de la Loi sur les crimes informatiques 1997.
- Prétendre être une autre personne, ou donner une fausse identité.
...
- Votre nom d'utilisateur et votre nom affiché ne doivent pas être offensants, trompeurs, ou empiéter sur les droits des tiers.
...
- Les résultats des parties, les notes et les positions des classements sont déterminés par les règles de l'App et affichés tels qu'enregistrés.
...
L'App est fournie **« telle quelle »** et **« telle quelle disponibilité »** sans garantie d'aucune sorte, qu'elle soit exprime ou implicite. Dans la mesure maximale permise par la loi, l'équipe ne sera pas responsable des dommages indirects, accessoires, spéciaux, ou consécutifs, ou de toute perte de données, résultant de votre utilisation de, ou de votre incapacité à utiliser, l'App.
...
Ces Conditions sont régies par les lois de **Malaisie**. Tout litige sera soumis à la juridiction des tribunaux malaisiens.
...
Nous pouvons mettre à jour ces Conditions de temps à autre. La version actuelle sera toujours disponible dans l'App. Votre utilisation continue de l'App après les modifications de ces Conditions constitue votre acceptation des Conditions mises à jour.
